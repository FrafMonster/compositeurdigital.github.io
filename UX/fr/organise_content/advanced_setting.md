...
* Métadonnées spécifiques au contenu
  * [Diaporama](metadatas/slideshow.md)
  * [Vidéo et audio](metadatas/video_audio.md)
  * [Web](metadatas/web.md)
  * [simulateur de prêt](metadatas/loan_simulator.md)
  * [Simulateur d'épargne](metadatas/savings_simulator.md)
  * [Objets 3D](metadatas/3d_objects.md)
  * [Interface de recherche](metadatas/search_interface.md)
* [Valeurs partagées](metadatas/shared_values.md)
...
> Exemple: 
>
>`actions.saveas.disabled = true`  pour cacher l'option "Save as"
>
>`actions.selection.location = shortcut` pour fournir un accès rapide à la séléction
...
|:--------------|-------------|
|`capture`      | Créer une image de capture du document tel qu'affiché |
